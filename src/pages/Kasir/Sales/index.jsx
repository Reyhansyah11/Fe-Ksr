                ...
                <>
                  <div className="overflow-x-auto">
                    <table className="w-full mb-4">
                      ...
                      <tbody>
                        {reportData.sales.map((sale, saleIdx) => (
                          <React.Fragment key={sale.penjualan_id}>
                            {sale.details.map((detail, idx) => (
                              <tr
                                key={`${sale.penjualan_id}-${idx}`}
                                className="border-b"
                              >
                                {/* Tampilkan info pelanggan hanya pada baris pertama dari grup transaksi */}
                                {idx === 0 && (
                                  <>
                                    <td
                                      rowSpan={sale.details.length}
                                      className="px-4 py-2"
                                    >
                                      {new Date(
                                ...
                                {/* Diskon hanya ditampilkan pada baris pertama */}
                                {idx === 0 && (
                                  <>
                                    <td
                                      rowSpan={sale.details.length}
